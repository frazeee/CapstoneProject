...
function AdoptionForm(props) {
  ...
  const willingToAllergies = watch("willingToAllergies");

  useEffect(() => {
    if (willingToAllergies === "No") {
      setShowWarning(true);
    }
  }, [willingToAllergies]);
    ...
    <>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="personal-form pt-3">
            ...
            <div className="col-12">
              ...
              {hasAllergies && (
                <p className="text-warning">
                  Note: Submitting an application despite having household
                  members with allergies means you acknowledge and accept the
                  potential risks associated with animal exposure.
                </p>
              )}
            </div>
          </div>
          ...
          <div>
            <p>
              Please attach photos of your home and place it under one .PDF
              file.
            </p>
            <p>Note:</p>
